...
*Last updated: August 7, 2026. Written for a new assistant/developer with no prior exposure to this project.*
...
| Tests | `scheduling/tests.py`, `erlang/tests.py`, `adherence/tests.py`, `finance/tests.py`, `nomina/tests.py` — run `python3 manage.py test`. As of the last commit: 416/416 passing |
