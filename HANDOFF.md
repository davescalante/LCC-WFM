...
37. **`remove_from_adherence_date` is not server-validated as a Monday on the separation form** (`process_separation` only parses it as a valid date) — see also §6.13.
