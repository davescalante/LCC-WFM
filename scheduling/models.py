...
class Agent(models.Model):
    ...
    can_access_admin_attendance = models.BooleanField(default=False, help_text="Access to Admin Attendance — supervisors see and edit their own team's attendance; super admins see everyone")
