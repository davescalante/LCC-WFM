...
class Agent(models.Model):
    ...
    adherence_start_date = models.DateField(
        null=True, blank=True,
        help_text="First Monday this agent should appear on the Adherence tab. Leave blank for no change — this is opt-in only."
    )
    ...
    adherence_bonus_max_mxn = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True, help_text="Individual adherence-bonus cap in MXN (uses global default if blank); proration rule is unchanged")
